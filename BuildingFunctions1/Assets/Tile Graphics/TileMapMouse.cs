...
public class TileMapMouse : MonoBehaviour {
	...
	void buildBase(){
		...
		Base newBuildingInfo = new Base("Base", 5, 1, 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, 5);
	...
	void buildFactory(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Factory newBuildingInfo = new Factory("Factory", 5, 1, 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, "pfc", 0.0003f);
	...
	void buildPowerPlant(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Powerplant newBuildingInfo = new Powerplant("Power Plant", 5, 1, 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, 0);
	...
	void buildMagnetosphere(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Magnetosphere newBuildingInfo = new Magnetosphere("Magnetosphere", 5, 1, 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, 25);
