	...
	public void upgradeBuilding(){
		...
		if (build.getStatus () == "Constructed" && build.getLevel () == 1) {
			if (resource >= build.getCost ()) {
				...
				//update turns to upgrade for upgrading to level 2
				if(build is Base){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Base") + 1);
				}else if(build is Beacon){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Beacon") + 1);
				}else if(build is Farm){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Farm") + 1);
				}else if(build is ResearchLab){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Research Lab") + 1);
				}else if(build is Warehouse){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Warehouse") + 1);
				}else if(build is Factory){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Factory") + 1);
				}else if(build is Powerplant){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Power Plant") + 1);
				}else if(build is Magnetosphere){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Magnetosphere") + 1);
				}else if(build is ChemistryPlant){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Chemistry Plant") + 1);
				}else if(build is Rover){
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Rover") + 1);
				}
				//put building into upgrading list
			...
			if (resource >= build.getCost ()) {
				...
				if(build is Base){
					...
					build.updateTurnsToUpgrade(PlayerInfo.player.getTurnsToBuildAtLevel1("Rover") + 2);
				}
				//put building into upgrading list
				PlayerInfo.player.insertUpgrading(build);
				showBuildingStats (build);
...
*/
	...
	void buildBeaconPrt2(){
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Beacon newBuildingInfo = new Beacon("Beacon", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 0);
	...
	void buildFarmPrt2(){
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Farm newBuildingInfo = new Farm("Farm", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 0, 10);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getTurnsToBuild() + " " + newBuildingInfo.getLevel() + " " + newBuildingInfo.getPowered());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
	...
	void buildResearchLabPrt2(){
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		ResearchLab newBuildingInfo = new ResearchLab("Research Lab", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 1, 1);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getTurnsToBuild() + " " + newBuildingInfo.getLevel() + " " + newBuildingInfo.getPowered());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
	...
	void buildWarehousePrt2(){
		Warehouse newBuildingInfo = new Warehouse("Warehouse", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 0);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getTurnsToBuild() + " " + newBuildingInfo.getLevel() + " " + newBuildingInfo.getPowered());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
	...
	void buildFactoryPrt2(){
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Factory newBuildingInfo = new Factory("Factory", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 0, 0.0003f);
	...
	void buildPowerPlantPrt2(){
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Powerplant newBuildingInfo = new Powerplant("Power Plant", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 0, 0);
	...
	void buildMagnetospherePrt2(){
		Magnetosphere newBuildingInfo = new Magnetosphere("Magnetosphere", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 0, 5);
	...
	void buildChemicalPlantPrt2(){
		ChemistryPlant newBuildingInfo = new ChemistryPlant("Chemistry Plant", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)currentTileCoord.x, (int)currentTileCoord.z, 0, 0.0003f);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getReleaseAmount());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
