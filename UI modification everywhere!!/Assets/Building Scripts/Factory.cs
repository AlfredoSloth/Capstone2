public class Factory : Building {
	...
	//constructor
	public Factory(string name, int cost, int turnsToBuild, int level,int x, int y, int powered, float releaseAmount) : base(name, cost, turnsToBuild, level, x, y, powered){
