...
public class Mars{
	...
	public void setAverageTemp(float temp){
		this.averageTemp = temp;
	}
	public void setMarsHasMegnetosphere(bool magnetosphere){
		this.marsHasMagnetosphere = magnetosphere;
	}
	public void setMarsAtmosphere(float atmosphere){
		this.marsAtmosphere = atmosphere;
	}
	public void setMarsOxygen(float oxygen){
