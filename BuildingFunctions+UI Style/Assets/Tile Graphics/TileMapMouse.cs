...
public class TileMapMouse : MonoBehaviour {
	...
	void buildBeacon(){
		...
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Beacon newBuildingInfo = new Beacon("Beacon", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0);
	...
	void buildFarm(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Farm newBuildingInfo = new Farm("Farm", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getTurnsToBuild() + " " + newBuildingInfo.getLevel() + " " + newBuildingInfo.getPowered());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
	...
	void buildResearchLab(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		ResearchLab newBuildingInfo = new ResearchLab("Research Lab", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 1);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getTurnsToBuild() + " " + newBuildingInfo.getLevel() + " " + newBuildingInfo.getPowered());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
	...
	void buildWarehouse(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Warehouse newBuildingInfo = new Warehouse("Warehouse", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getTurnsToBuild() + " " + newBuildingInfo.getLevel() + " " + newBuildingInfo.getPowered());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
	...
	void buildFactory(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Factory newBuildingInfo = new Factory("Factory", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, 0.0003f);
	...
	void buildPowerPlant(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Powerplant newBuildingInfo = new Powerplant("Power Plant", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, 0);
	...
	void buildMagnetosphere(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		Magnetosphere newBuildingInfo = new Magnetosphere("Magnetosphere", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, 5);
	...
	void buildChemicalPlant(){
		...
		GameObject newBulding = (GameObject)Instantiate(instance, new Vector3((selectedTileCoord.x+0.5f), selectedTileCoord.y, (selectedTileCoord.z+0.5f))*3f, Quaternion.identity);
		//Debug.Log("Creating new building at coords: " + selectedTileCoord.x + "," + selectedTileCoord.z);
		ChemistryPlant newBuildingInfo = new ChemistryPlant("Chemistry Plant", PlayerInfo.player.getCostAtLevel1 (place), PlayerInfo.player.getTurnsToBuildAtLevel1 (place), 1, (int)selectedTileCoord.x, (int)selectedTileCoord.z, 0, 0.0003f);
		Debug.Log("Creating new building info: " + newBuildingInfo.getName() + " " + newBuildingInfo.getCost() + " " + newBuildingInfo.getReleaseAmount());
		TGMap.map.GetTileAt((int)selectedTileCoord.x, (int)selectedTileCoord.z).updateBulding(newBuildingInfo);
